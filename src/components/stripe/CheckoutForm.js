...
export const CheckoutForm = ({ totalAmount }) => {
  ...
  return paymentMethod ? (
    <div className="mt-12 text-center bg-[#b2eb83] rounded-lg">
      <div
        className="  text-darkBlue font-semibold mb-2 text-lg text-center"
        role="alert"
      >
    ...
    <>
      <form
        className="p-4 rouded shadow-lg shadow-slate-400 "
